...
from lagou.setting import headers
from lagou.setting import cookies
import time
import logging
import codecs
...
def getInfo(url, para):
    ...
    获取信息
    """
    pro = {"https": "https://183.47.237.251:80"}

    generalHttp = Http()
    htmlCode = generalHttp.post(url, para=para, headers=headers, cookies=cookies, proxy=pro)
    print(htmlCode)
